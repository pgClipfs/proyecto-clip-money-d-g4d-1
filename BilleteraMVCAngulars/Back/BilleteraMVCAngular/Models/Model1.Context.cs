...
namespace BilleteraMVCAngular.Models
{
    ...
    public partial class billeteraClipEntities : DbContext
    {
        public billeteraClipEntities()
            : base("name=billeteraClipEntities")
        {
        }
        ...
        public virtual DbSet<Tipo_Mov> Tipo_Mov { get; set; }
